 ...
 * @author GREGORIO-PC
 */
public class InventarioMensual extends javax.swing.JFrame {
Controladora control = new Controladora();
  String nombreUsuario="";
    /**
     * Creates new form InventarioMensual
     */
    public InventarioMensual() {
        initComponents();
    }
     public InventarioMensual(String nombreUsuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inventario Mensual");
    ...
    private void piezasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_piezasActionPerformed
       try{
                ...
                String path="C:\\Users\\GREGORIO-PC\\Documents\\NetBeansProjects\\airUcab\\build\\classes\\reporte\\InventarioPiezas.jasper";
    ...
    private void materialesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialesActionPerformed
        try{
                ...
                JasperReport reporte;
                String path="C:\\Users\\GREGORIO-PC\\Documents\\NetBeansProjects\\airUcab\\build\\classes\\reporte\\reportInventario.jasper";
                reporte=(JasperReport) JRLoader.loadObjectFromFile(path);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioMensual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarioMensual().setVisible(true);
            }
        });
    }
