...
public class EliminarModelo extends javax.swing.JFrame {
 ...
 String instruccion="eliminar";
    ...
    public EliminarModelo() {
     ...
     public EliminarModelo(String nombreUsuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Elliminar Modelo");

        jLabel2.setText("modelo :");

        botonEliminarModelo.setText("Eliminar");
    ...
    private void botonEliminarModeloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarModeloActionPerformed
      ...
      if (control.buscarPermiso(instruccion, nombreEntidad,nombreUsuario)==1){
        verificar = control.buscarModelo(txtModelo.getText());
         if (verificar == 1){
            control.eliminarModelo(txtModelo.getText());
            JOptionPane.showMessageDialog(null, "Modelo " + txtModelo.getText(), " Eliminado", JOptionPane.INFORMATION_MESSAGE);
           txtModelo.setText("");
         }
         else
             if (verificar == 2){
               JOptionPane.showMessageDialog(null, "Modelo " + txtModelo.getText(), " no encontrado", JOptionPane.INFORMATION_MESSAGE);
                 txtModelo.setText("");
                  ...
                  if (verificar ==0){
                   JOptionPane.showMessageDialog(null, "Modelo " + txtModelo.getText(), " error al elimianr", JOptionPane.ERROR_MESSAGE);
                    txtModelo.setText("");
               }
      }
       else
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarModelo().setVisible(true);
            }
        });
    }
